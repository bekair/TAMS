...
{
    public class TennisCoachRepository : RepositoryBase<TennisCoach, TamsDbContext>, ITennisCoachRepository
    {
        public TennisCoachRepository(TamsDbContext context) : base(context)
        {
        }
    }
}
